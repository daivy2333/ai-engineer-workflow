...
| 3 Inline | executing-plans + /opsx:apply | Gate 3/4/5/6 + Loop 3/4 + Iron Law |
| 3 Subagent | subagent-driven-development + /opsx:apply | Gate 3/4/5/6 + 并行 + Iron Law |
| 4 | finishing-a-development-branch + /opsx:archive | Gate 5 + Loop 5 |
